...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar md:w-71 bg-background p-2 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(7)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
